...
def showclass():
    ...
    data = {'Class' : 'Count', 'Anatidae' : anatidae, 'Ardeidae' : ardeidae, 'Columbidae' : columbidae, 'Sturnidae' : sturnidae,
    ...
    return render_template("class.html",rows=rows, data=data)
...
def showspecies():
    ...
    data = {'EnglishName' : 'Count', 'Asian_Glossy_Starling' : Asian_Glossy_Starling, 'Barn_Swallow' : Barn_Swallow, 'Black-Crowned_Night_Heron' : BlackCrowned_Night_Heron,
    ...
    con.close()
    # Send the results of the SELECT to the list.html page
    return render_template("species.html",rows=rows, data=data)
